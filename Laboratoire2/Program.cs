    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while(endGame == false)
            {
                ...
                while (choixJoueur1Invalide == false)
                {
                    //Main du joueur
                ...
                else
                {
                    ...
                    else if (monOrdi.tabCarte[1].valeurCarte == carteMin)
                    {
                        ...
                        {
                            monOrdi.tabCarte[1] = carteMilieu;
                            GenereCarteMilieu(carteMilieu);
                            Console.WriteLine(" L'IA prend la carte du centre");
                            Console.ReadKey();
                            Console.Clear();
                    ...
                    else if (monOrdi.tabCarte[2].valeurCarte == carteMin)
                    {
                        ...
                        {
                            monOrdi.tabCarte[2] = carteMilieu;
                            GenereCarteMilieu(carteMilieu);
                            Console.WriteLine(" L'IA prend la carte du centre");
                            Console.ReadKey();
                            Console.Clear();
            ...
            if(endGame == true)
            {
                ...
                Console.WriteLine(" Pointage IA : " + pointageJoueur1);
                Console.WriteLine("");
                Console.WriteLine("");

                if (pointageJoueur1 > pointageOrdi)
                {
                    Console.WriteLine("Le gagnant est : " + monJoueur);
                    Console.ReadKey();
                    Console.Clear();
                }
                else
